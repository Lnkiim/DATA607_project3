...
For cloud platforms, we are only interested in seeing the combined results for the service provider. For instance, for AWS we are currently seeing 5 naming variations. We would like to  reconcile the naming variations under AWS to get the combined results. This applies to Azure and Google Cloud as well.
